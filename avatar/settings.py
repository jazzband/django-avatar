...
AVATAR_DEFAULT_URL_DIR = getattr(settings, 'AVATAR_DEFAULT_URL_DIR', 'avatar/img/')
AVATAR_DEFAULT_URL_FILE = getattr(settings, 'AVATAR_DEFAULT_URL_FILE', 'default.jpg')
AVATAR_DEFAULT_URL = getattr(settings, 'AVATAR_DEFAULT_URL', '%s/%s' % (AVATAR_DEFAULT_URL_DIR, AVATAR_DEFAULT_URL_FILE))
...
AVATAR_TARGET_HANDLER = getattr(settings, 'AVATAR_TARGET_HANDLER', 'avatar.handlers.DefaultTargetHandler')
