...
AVATAR_UPDATED_MSG = getattr(settings, 'AVATAR_UPDATED_MSG', "Successfully updated your avatar.")
AVATAR_DELETED_MSG = getattr(settings, 'AVATAR_DELETED_MSG', "Successfully deleted the requested avatars.")
AVATAR_UPLOADED_MSG = getattr(settings, 'AVATAR_UPLOADED_MSG', "Successfully uploaded a new avatar.")
